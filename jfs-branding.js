...
(function(){
  function mount(){
    ...
    brand.className='fixed top-3 left-3 z-[9999] flex items-center gap-1.5 rounded-lg border border-slate-700/70 bg-slate-950/90 px-2 py-1.5 shadow-lg backdrop-blur';
    brand.innerHTML='<img src="logo-jfs.png" alt="JFS AI" class="w-6 h-6 rounded-md object-contain bg-white p-0.5"><div class="leading-tight"><div class="text-[9px] font-extrabold text-white">JFS AI</div><div class="text-[7px] text-slate-400">TECHNOLOGY</div></div>';
