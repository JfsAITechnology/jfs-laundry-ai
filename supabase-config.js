...
if(location.pathname.endsWith('/orders.html')) document.write('<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"><\/script><script src="admin-orders-db.js"><\/script><script src="admin-orders-bind.js"><\/script>');
